...
[![My Skills](https://skillicons.dev/icons?i=py,vim,vite,js,cs,go,rust,html,css,scss,nodejs,react,vuejs,angular,git,vscode,atom,figma,bootstrap,fastapi,flask,gitlab,idea,mongodb,postgres,postman,sqlite,stackoverflow,ts)](https://vk.com/official_hexvel)
